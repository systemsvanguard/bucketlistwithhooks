...
import ScarboroughBluffs from "../app/images/scarboroughbluffs.jpg"

const About = () => {
  return (
    <div className="container">
    <h1 className="is-size-3 has-text-weight-bold has-text-link has-text-centered">About Us</h1>
    <img src={ScarboroughBluffs} className="img_responsive" alt="Scarborough Bluffs" title="Scarborough Bluffs" />
